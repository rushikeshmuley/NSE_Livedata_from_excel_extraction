...
class NSEIndia:
    ...
    def __init__(self):
        self.headers = {'user-agent': 'Mozilla/5.0 (Linux; Android) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.109 Safari/537.36 CrKey/1.54.248666 Edg/124.0.0.0'}
